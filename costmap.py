...
CLASS_SAFETY_PROFILES: Dict[str, Dict[str, Any]] = {
    "person":    {"base_cost": 255, "footprint_radius": 0.8, "inflation_sigma": 2.5, "color": (0, 0, 255)},
    "bicycle":   {"base_cost": 240, "footprint_radius": 1.0, "inflation_sigma": 2.2, "color": (0, 69, 255)},
    "motorcycle":{"base_cost": 220, "footprint_radius": 1.2, "inflation_sigma": 2.0, "color": (0, 140, 255)},
    "dog":       {"base_cost": 250, "footprint_radius": 0.8, "inflation_sigma": 2.2, "color": (128, 0, 255)},
    "cow":       {"base_cost": 255, "footprint_radius": 1.6, "inflation_sigma": 2.8, "color": (0, 0, 220)},
    "horse":     {"base_cost": 250, "footprint_radius": 1.6, "inflation_sigma": 2.6, "color": (0, 0, 220)},
    "car":       {"base_cost": 180, "footprint_radius": 1.8, "inflation_sigma": 2.0, "color": (0, 215, 255)},
    "bus":       {"base_cost": 220, "footprint_radius": 2.5, "inflation_sigma": 2.8, "color": (0, 165, 255)},
    "truck":     {"base_cost": 220, "footprint_radius": 2.5, "inflation_sigma": 2.8, "color": (0, 165, 255)},
    "default":   {"base_cost": 180, "footprint_radius": 1.5, "inflation_sigma": 2.0, "color": (0, 255, 255)}
}
